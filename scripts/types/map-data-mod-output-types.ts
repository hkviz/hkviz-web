...
import type { Vector3Like, Vector4Like } from '~/lib/game-data/shared/vector-like.ts';
import type { PlayerDataFieldNameSilk } from '~/lib/game-data/silk-data/player-data/player-data-silk.generated.ts';

...
export const enemiesJournalLang: Record<string, string> = {
    ...
    NAME_ZOM_BEAM_MINER: 'Crystallised Husk',
    DESC_HEALTH_SCUTTLER:
        'Small scuttling seed filled with Lifeblood, which can be extracted and consumed for its healthful properties.',
    NOTE_ZOTE_HOPPER:
        '&quot;That lowly map-maker&#39;s wife? Hah! My Queen, how could you compare yourself to her? In the face of your intoxicating beauty, all other females are merely dust!&quot;&lt;br&gt;The Grey Prince trembled with anger and indignation... and love.&lt;br&gt;- &#39;The Grey Prince&#39; Chapter 178',
    NAME_JELLY_CRAWLER: 'Uoma',
    NOTE_CRYS_CRAWLER:
    ...
    NAME_MUSH_ROLLER: 'Shrumal Warrior',
    NAME_FINAL_BOSS: 'Radiance',
    NAME_MAGEBLOB: 'Mistake',
    NAME_GORGEOUS_HUSK: 'Gorgeous Husk',
    DESC_MOSSMAN_SHAKER: 'Plant-like bug swollen with infection. Releases deadly gas when threatened.',
    NOTE_ABYSS_TENDRIL:
    ...
    NAME_EGG_SAC: 'Bluggsac',
    NAME_BLOBBLE: 'Battle Obble',
    NOTE_MENDERBUG: 'The bugs of Hallownest were obsessed with building things. What strange little minds they had.',
    DESC_BEE: 'Defends the Hive against intruders with its extendable stinger.',
    DESC_BOUNCER: 'Simple-minded creature that haphazardly buzzes around, bumping into things.',
    DESC_FLAMEBEARER_SMALL:
    ...
    NAME_MIMIC_SPIDER: 'Nosk',
    DESC_SPITTER: 'Bests its prey by spitting corrosive liquid. Often hunts in packs.',
    DESC_ROYAL_GUARD:
    ...
    NAME_LAZY_FLYER: 'Aluba',
    NAME_SAGE_SLY: 'Great Nailsage Sly',
    NOTE_ANGRY_BUZZER:
    ...
    DESC_BIGFLY: 'Mature gruzzer that carries its young in its belly. Attacks by hurling its huge body around.',
    DESC_GHOST_MARMU: 'Lingering dream of a fallen warrior. Protector of the Queen&#39;s Gardens.',
    NOTE_ROYAL_GUARD:
        'They say the old King died long ago, but his influence echoes around us still. A creature like that... what did he desire?',
    NOTE_SAGE_SLY:
        '&quot;Sagely God of the cunning and bold,&lt;br&gt;Sharpen Our nails and show Us the odds,&lt;br&gt;O greatest of masters, We wish to behold,&lt;br&gt;That one still greater, the God of Gods!&quot;&lt;br&gt;- Prayer to the Sage',
    NOTE_MAGE_LORD:
    ...
    DESC_INFLATOR: 'Tiny and placid but swells to enormous size when threatened.',
    NAME_GHOST_HU: 'Elder Hu',
    DESC_OBLOBBLE: 'Larger cousin of the Obble. Pairs with a mate for life and will never leave its side.',
    ...
    DESC_GREY_PRINCE: 'Figment of an obsessed mind. Lacks grace but becomes stronger with every defeat.',
    NOTE_FUNGOON_BABY:
    ...
    NAME_MOSS_KNIGHT_FAT: 'Mossy Vagabond',
    NOTE_HUNTERMARK:
    ...
    NAME_BEE: 'Hive Soldier',
    DESC_MAWLEK: 'Ferocious but extremely social creature. Becomes aggressive if not able to mingle with its own kind.',
    DESC_PIGEON: 'Harmless flying creature that favours serene environments. Usually travels in flocks.',
    DESC_MAGE_LORD:
    ...
    NAME_COL_HOPPER: 'Death Loodle',
    NAME_WHITE_ROYAL: 'Royal Retainer',
    DESC_FUNG_ZOMBIE: 'The remains of a bug, consumed by a fungus. Frequently releases clouds of thick, deadly gas. ',
    DESC_CRYS_CRAWLER:
    ...
    NAME_SLASH_SPIDER: 'Stalking Devout',
    DESC_PRAYER_SLUG:
        'Weakest members of the kingdom of Hallownest. Generally looked down upon and forced to do menial labour.',
    DESC_LAZY_FLYER: 'Passive glider that prefers to dwell near acid waters.',
    DESC_MENDERBUG:
        'Member of an elusive guild of bugs fixated on the maintenance of Hallownest&#39;s many signs and wayposts.',
    NAME_VOID_IDOL_2: 'Void Idol',
    DESC_KIN_SEAL:
        'Intricate seal of ancient design.&lt;br&gt;&lt;br&gt;Used to contain a powerful force, or to preserve something of great importance.',
    NOTE_ZAP_BUG:
    ...
    NAME_ZOM_ROYAL_1: 'Husk Dandy',
    NAME_ROYAL_GUARD: 'Kingsmould',
    NAME_CRYS_CRAWLER: 'Glimback',
    NOTE_MINES_CRAWLER:
    ...
    NAME_NIGHTMARE_GRIMM: 'Nightmare King',
    NOTE_GHOST_MARMU:
        'If you believe in something as hard as you can, with your eyes shut tight... eventually it will come true!&lt;br&gt;- Marmu',
    DESC_MEGA_MOSS_CHARGER: 'Family of creatures that have learnt to bulk up with moss and live as one.',
    NOTE_BOUNCER:
    ...
    NAME_GHOST_XERO: 'Xero',
    DESC_ROLLER:
        'Rolls into a ball and propels itself at intruders who wander into its territory. Aggressive even when newly born.',
    DESC_SENTRY_FLYING_JAVELIN:
        'Winged Sentry of Hallownest equipped with a nail-lance. Charges at threats or throws its lance from a distance.',
    NAME_FUNG_ZOMBIE: 'Fungified Husk',
    DESC_ZOM_SPITTING: 'The body of a bug, completely consumed by infection. Spits corrosive liquid.',
    DESC_FLUKEFLY: 'Youngest of its species. Its body is composed of teeth, wings and stomach.',
    DESC_BUZZER: 'Flying predator that pursues its prey relentlessly.',
    NOTE_ROLLER:
    ...
    DESC_MEGA_JELLYFISH: 'Intelligent being that guards the inner chamber of the Teacher&#39;s Archives.',
    NOTE_MUSH_ROLLER:
    ...
    NOTE_EGG_SAC: 'Easily tracked down if you have a sense of smell. I strongly suggest you do not eat its eggs.',
    DESC_COL_FLYINGSENTRY:
    ...
    NAME_BLACK_KNIGHT: 'Watcher Knight',
    NAME_MANTIS_HEAVY: 'Mantis Traitor',
    NOTE_ORANGE_BALLOON:
    ...
    DESC_WHITE_DEFENDER: 'Figure from a fondly remembered past. Reacts gallantly to defeat by becoming stronger.',
    DESC_FLUKEMAN: 'Worm-like creature that prefers damp, dark habitats.',
    NOTE_CENTIPEDE_HATCHER:
    ...
    NAME_SPITTER: 'Aspid Hunter',
    NAME_OBLOBBLE: 'Oblobble',
    NOTE_ZOM_SPITTING:
    ...
    NAME_CEILING_DROPPER: 'Belfly',
    DESC_MOSS_KNIGHT: 'Protector of the Greenpath, trained in the ways of the Nail and the Shell.',
    NOTE_MAGE:
    ...
    DESC_HOLLOW_KNIGHT: 'Fully grown Vessel, carrying the plague&#39;s heart within its body.',
    DESC_MIMIC_SPIDER: 'Mimics the shape of other creatures to lure prey to its lair.',
    NAME_COL_MINER: 'Sturdy Fool',
    NOTE_MEGA_BEAM_MINER:
    ...
    DESC_TRAITOR_LORD: 'Deposed Lord of the Mantis tribe. Embraced the infection and turned against his sisters.',
    NAME_ACID_WALKER: 'Durandoo',
    NAME_ZOTE: 'Zote',
    NAME_VOID_IDOL_1: 'Void Idol',
    NOTE_GREY_PRINCE:
        '&quot;My love, any creature who could bear to be away from you, who would willingly leave you behind or say unkind things to you... Pah! Lowly maggots, not worthy of standing in your glorious shadow!&quot;&lt;br&gt;She felt her cold body grow warm, a sensation she had almost forgotten...&lt;br&gt;- &#39;The Grey Prince&#39; Chapter 112',
    NAME_ABYSS_CRAWLER: 'Shadow Creeper',
    DESC_HATCHLING: 'Recently birthed, these young aspid instinctively swarm around intruders.',
    NAME_BIGFLY: 'Gruz Mother',
    NAME_MOSSMAN_RUNNER: 'Mosskin',
    NAME_GHOST_ALADAR: 'Gorb',
    DESC_BABY_CENTIPEDE:
    ...
    DESC_BURSTING_BOUNCER: 'Gruzzer swollen with infection and primed to burst.',
    NAME_PALACE_FLY: 'Wingmould',
    NOTE_GHOST_MARKOTH: 'May your efforts lead you somewhere worthy.&lt;br&gt;- Markoth',
    DESC_VOID_IDOL_3:
    ...
    NOTE_FLAMEBEARER_MED:
        '&quot;A spark of red lights darkest dream,&lt;br&gt;Scarlet nightmares bright and wild,&lt;br&gt;Visions dance and flames do speak,&lt;br&gt;Burn the father, feed the child.&quot;&lt;br&gt;- &#39;The Grimm Troupe&#39;',
    NOTE_GODSEEKER_MASK:
        '&quot;Gods of Thunder, Gods of Rain! Why forsake thy servants? Will Our minds be left suffering, to ache alone? What God remains to deliver Us from this woeful silence?&quot;&lt;br&gt;- Lament of the Godseekers',
    NAME_ZOM_HIVE: 'Husk Hive',
    NAME_MANTIS_FLYER_CHILD: 'Mantis Youth',
    NOTE_SENTRY_FLYING:
    ...
    NAME_ZOTE_HOPPER: 'Hopping Zoteling',
    NAME_ROLLER: 'Baldur',
    NAME_PIGEON: 'Maskfly',
    NAME_MEGA_MOSS_CHARGER: 'Massive Moss Charger',
    NAME_KIN_SEAL: 'Seal of Binding',
    NOTE_FLAMEBEARER_SMALL:
        '&quot;Shadows dream of endless fire,&lt;br&gt;Flames devour and embers swoop,&lt;br&gt;One will light the Nightmare Lantern,&lt;br&gt;Call and serve in Grimm&#39;s dread Troupe.&quot;&lt;br&gt;- &#39;The Grimm Troupe&#39;',
    NOTE_NAILMASTERS:
        '&quot;Gods by toil and nail bound,&lt;br&gt;Brothers sworn to guard the weak,&lt;br&gt;Masters of the sacred ground,&lt;br&gt;Help Us find the God We seek!&quot;&lt;br&gt;- Prayer to the Masters',
    NAME_JAR_COLLECTOR: 'The Collector',
    NOTE_VOID_IDOL_3:
        '&quot;Inspired or mad, those ancient bugs. They devoted their worship to no lord, or power, or strength, but to the very darkness itself.&quot;&lt;br&gt;- Lemm',
    NOTE_ZOM_LEAPER:
    ...
    DESC_ZOM_ROYAL_1: 'Former member of Hallownest&#39;s high society. Limited offensive ability.',
    NAME_FAT_FLUKE: 'Flukemunga',
    NOTE_MANTIS_FLYER_ADULT:
    ...
    NAME_GHOST_MARKOTH: 'Markoth',
    DESC_BIG_BEE: 'Protects the Hive by hurling its huge body at intruders. ',
    NOTE_MOSS_FLYER:
    ...
    DESC_NAILMASTERS: 'Brothers of the nail, trained in combat by the Great Nailsage.',
    NAME_ZOM_RUNNER: 'Wandering Husk',
    NOTE_ZOM_BEAM_MINER:
    ...
    DESC_EGG_SAC: 'Placid but putrid creature. Holds rancid eggs within its gut.',
    DESC_CLIMBER: 'Uses its small, sharp claws to climb along walls and rooves.',
    NOTE_MAGEBLOB:
    ...
    DESC_COL_HOPPER: 'Loodle equipped with a helmet and taught to kill.',
    NOTE_BUZZER:
    ...
    DESC_MUSH_BRAWLER: 'Huge fungal creature. Attacks by spitting corrosive venom and slamming its body into foes.',
    NAME_GRIMM: 'Grimm',
    NOTE_HORNET:
    ...
    NAME_GREAT_SHIELD_ZOMBIE: 'Great Husk Sentry',
    NOTE_JELLYFISH:
    ...
    NAME_BIGBUZZER: 'Vengefly King',
    DESC_FLAMEBEARER_MED:
    ...
    NAME_MOSS_FLYER: 'Mossfly',
    DESC_ZOM_SHIELD: 'The remains of a bug, animated by a strange force. Wields a nail and shell.',
    NAME_TRAITOR_LORD: 'Traitor Lord',
    NOTE_WHITE_ROYAL:
    ...
    NOTE_GRIMM:
        '&quot;Through dream I travel, at lantern&#39;s call,&lt;br&gt;To consume the flames of a kingdom&#39;s fall.&quot;&lt;br&gt;- Grimm',
    NOTE_MUSH_TURRET:
    ...
    DESC_MOSS_CHARGER: 'Timid creature that frightens away intruders by covering itself in huge clumps of moss.',
    NOTE_MOSSMAN_RUNNER:
    ...
    NAME_HOLLOW_SHADE: 'Shade',
    NOTE_ZOM_SPINE:
        'The spines they fire seem to be mildly poisonous. Don&#39;t use them to clean between your fangs after eating!',
    NOTE_VOID_IDOL_1:
        '&quot;Inspired or mad, those ancient bugs. They devoted their worship to no lord, or power, or strength, but to the very darkness itself.&quot;&lt;br&gt;- Lemm',
    NAME_MAWLEK: 'Brooding Mawlek',
    DESC_SIBLING: 'Fragment of a lingering will.',
    DESC_MAWLEK_TURRET: 'Large, immobile creature. Wildly spits venom when intruders pass by.',
    DESC_COL_ROLLER:
        'Hardened baldur, bred for battle in the Colosseum of Fools. Tougher and more aggressive than its wild ancestor.',
    NAME_HEALTH_SCUTTLER: 'Lifeseed',
    NAME_MUSH_TURRET: 'Sporg',
    NAME_ZOTE_BALLOON: 'Volatile Zoteling',
    NAME_MOSQUITO: 'Squit',
    DESC_GRIMM: 'Master of the Grimm Troupe.',
    NAME_LESSER_MAWLEK: 'Lesser Mawlek',
    NAME_MAGE_LORD: 'Soul Master',
    NAME_PRAYER_SLUG: 'Maggot',
    NAME_FLAMEBEARER_SMALL: 'Grimmkin Novice',
    NAME_INFECTED_KNIGHT: 'Broken Vessel',
    NOTE_COL_MINER:
        'You can hit this warrior&#39;s spinning weapons out of the air, straight back into them! Useful if they manage to corner you.',
    NAME_PALE_LURKER: 'Pale Lurker',
    NAME_MENDERBUG: 'Menderbug',
    NAME_LOBSTER_LANCER: 'God Tamer',
    DESC_MANTIS_LORD:
    ...
    NAME_ANGRY_BUZZER: 'Furious Vengefly',
    NOTE_MUSH_BABY:
    ...
    NAME_BLOCKER: 'Elder Baldur',
    DESC_HIVE_KNIGHT: 'Loyal protector of the Hive&#39;s Queen. Flightless but ferocious in battle.',
    NOTE_PALACE_FLY:
    ...
    NAME_FUNG_CRAWLER: 'Ambloom',
    DESC_ZAP_BUG: 'When threatened they cluster together, generating electricity.',
    DESC_MANTIS_FLYER_CHILD:
    ...
    DESC_GIANT_HOPPER: 'Leaps around the edge of the world, trying to crush prey beneath its body.',
    NAME_ORANGE_BALLOON: 'Infected Balloon',
    NAME_FLUKE_MOTHER: 'Flukemarm',
    DESC_ZOM_ROYAL_2:
    ...
    DESC_MAGEBLOB: 'Once a highly intelligent bug, deformed by the misuse of soul.',
    DESC_MUSH_ROLLER: 'Fungal creature that attacks intruders to protect its young.',
    NOTE_COL_MOSQUITO: 'Strong and quick! When they rear back, either move out of the way or prepare to strike back!',
    DESC_CRYS_FLYER: 'Fires shards of fast-growing crystal at intruders.',
    NOTE_MINI_SPIDER:
    ...
    NAME_COL_MOSQUITO: 'Armoured Squit',
    DESC_MANTIS:
        'Member of a proud tribe, fiercely protective of its territory. Launches savage attacks with bladed forelimbs.',
    NOTE_FUNG_CRAWLER: 'Lie on your belly, open your maw and let this tasty morsel stroll straight into your stomach.',
    NAME_COL_SHIELD: 'Shielded Fool',
    NOTE_BIG_CENTIPEDE:
    ...
    NAME_FLIP_HOPPER: 'Pilflip',
    NAME_SNAPPER_TRAP: 'Fool Eater',
    NAME_MAGE: 'Soul Twister',
    NAME_ACID_FLYER: 'Duranda',
    NOTE_GHOST_NOEYES:
        'They&#39;re coming...&lt;br&gt;What&#39;s inside of you...&lt;br&gt;Strip it out!&lt;br&gt;- No Eyes',
    NOTE_ZOM_HORNHEAD:
        'These bugs have an arrogant air about them, even after dying. Overly proud of their long horns! I enjoy snapping them off.',
    NAME_ZOM_MINER: 'Husk Miner',
    NAME_NAILMASTERS: 'Nailmasters Oro &amp; Mato',
    NOTE_MANTIS_FLYER_CHILD:
    ...
    NAME_BEE_HATCHLING: 'Hiveling',
    NAME_ZOM_BURSTING: 'Violent Husk',
    NAME_CRYS_FLYER: 'Crystal Hunter',
    NAME_MUMMY: 'Entombed Husk',
    DESC_SPITTING_SPIDER: 'Crawls along walls and roofs, spitting burning venom at anything that passes by.',
    DESC_FAT_FLUKE: 'Aged fluke, grown fat on the rich refuse found in the pipes below the capital.',
    NOTE_ZOM_ROYAL_1:
    ...
    NAME_GHOST_GALIEN: 'Galien',
    NAME_MANTIS: 'Mantis Warrior',
    DESC_GODSEEKER_MASK:
    ...
    DESC_ABYSS_TENDRIL: 'Fragments of void taking the shape of sharp, thrashing tendrils.',
    NOTE_WHITE_DEFENDER:
        '&quot;The Champion&#39;s Call, the Knotted Grove, the Battle of the Blackwyrm... I remember it all. I will carry those glories with me always... until we meet again.&quot;&lt;br&gt;- Ogrim of the Five Knights',
    DESC_ZOM_HORNHEAD:
    ...
    NAME_MOSS_CHARGER: 'Moss Charger',
    DESC_BEE_HATCHLING: 'Smallest of the Hive&#39;s inhabitants. Carries out simple tasks.',
    NOTE_ZOM_GUARD:
    ...
    DESC_PALACE_FLY: 'A fly-like construct formed of white shell and a dark liquid interior.',
    DESC_BIGBUZZER:
    ...
    NOTE_INFLATOR: 'Extremely amusing creature.',
    NOTE_CRAWLER: 'Dull and pathetic. Hardly worth killing.',
    NOTE_LESSER_MAWLEK:
    ...
    NOTE_MOSS_KNIGHT_FAT:
        'Slow, fat and easily vanquished; common threads in those who forget their calling and forsake their duties.',
    NAME_BIG_BEE: 'Hive Guardian',
    DESC_WHITE_ROYAL: 'The most loyal and devout servants of the King.',
    NAME_MANTIS_FLYER_ADULT: 'Mantis Petra',
    NAME_HIVE_KNIGHT: 'Hive Knight',
    NOTE_FUNG_ZOMBIE:
    ...
    DESC_MAGE_BALLOON: 'Once a highly intelligent bug, inflated by misuse of soul.',
    NOTE_ZOTE:
        'Some rare creatures are so weak, so helpless, so inept and so irritating that hunting them gives no pleasure.',
    DESC_GHOST_NOEYES: 'Lingering dream of a fallen warrior. Disappeared during the plague.',
    NAME_ABYSS_TENDRIL: 'Void Tendrils',
    DESC_MINI_SPIDER: 'Infant of the Deepnest. Scuttles about in the darkness, learning the layout of its home.',
    DESC_LOBSTER_LANCER: 'Veteran warrior of the Colosseum of Fools. Fights by the side of creatures she has trained.',
    NAME_CENTIPEDE_HATCHER: 'Carver Hatcher',
    DESC_MINES_CRAWLER: 'Feeds on crystal dust and uses crystallised spines to protect itself from danger.',
    NOTE_MAGE_BALLOON:
    ...
    DESC_HORNET: 'Skilled protector of Hallownest&#39;s ruins. Wields a needle and thread.',
    NOTE_VOID_IDOL_2:
        '&quot;Inspired or mad, those ancient bugs. They devoted their worship to no lord, or power, or strength, but to the very darkness itself.&quot;&lt;br&gt;- Lemm',
    NAME_SPIDER_FLYER: 'Little Weaver',
    DESC_HOPPER: 'Leaps at prey and uses its sharp proboscis to drain vital fluids.',
    NOTE_SLASH_SPIDER:
    ...
    NAME_WHITE_DEFENDER: 'White Defender',
    NAME_ZOM_SPITTING: 'Slobbering Husk',
    DESC_CENTIPEDE_HATCHER: 'Flying creature that fires out dirtcarvers from its body when potential prey comes close.',
    DESC_COL_MOSQUITO:
    ...
    NAME_SUPER_SPITTER: 'Primal Aspid',
    NOTE_FLIP_HOPPER:
    ...
    NAME_ZAP_BUG: 'Charged Lumafly',
    NAME_BURSTING_BOUNCER: 'Volatile Gruzzer',
    NOTE_BLOBBLE: 'They have crafted a tiny mask for it! Is such an extravagance practical I wonder?',
    NOTE_MANTIS_HEAVY:
    ...
    NAME_FUNGOON_BABY: 'Fungling',
    NOTE_FLAMEBEARER_LARGE:
        '&quot;Dance and die and live forever,&lt;br&gt;Silent voices shout and sing,&lt;br&gt;Stand before the Troupe&#39;s dark heart,&lt;br&gt;Burn away the Nightmare King.&quot;&lt;br&gt;- &#39;The Grimm Troupe&#39;',
    NAME_SIBLING: 'Sibling',
    DESC_ACID_FLYER: 'Simple flying creature protected by a spikey shell.',
    DESC_MANTIS_HEAVY: 'Once a member of the Mantis tribe, now cast out and driven mad by infection.',
    DESC_MOSS_FLYER:
    ...
    DESC_PAINTMASTER: 'Skilled and respected master of the nail. Always eager to learn new things.',
    NOTE_SENTRY_FLYING_JAVELIN:
    ...
    NAME_MUSH_BABY: 'Shrumeling',
    DESC_PALE_LURKER: 'Forgotten champion of the Colosseum, drawn away by strange obsessions.',
    NAME_HATCHLING: 'Aspid Hatchling',
    NAME_BOUNCER: 'Gruzzer',
    DESC_ZOM_BARGER:
        'The remains of a bug, animated by a strange force. It aggressively attacks any uninfected creature it finds.',
    NAME_BIG_CENTIPEDE: 'Garpede',
    NAME_SENTRY_FAT: 'Heavy Sentry',
    NOTE_ZOM_RUNNER:
    ...
    DESC_MANTIS_FLYER_ADULT: 'Lurks amongst foliage and attacks by flinging wind-scythes from a distance.',
    DESC_GRASS_HOPPER:
        'Inhabits the wilds beside the Queen&#39;s Gardens. Not aggressive in nature, but its wild bouncing behaviour can be dangerous.',
    NAME_MEGA_JELLYFISH: 'Uumuu',
    NAME_MANTIS_LORD: 'Mantis Lords',
    DESC_WORM: 'Thickly armoured, it bursts from the ground to seize prey in its fangs.',
    NOTE_BLOB_FLYER:
    ...
    DESC_ZOM_SPINE: 'Overgrown with vegetation, it attacks by firing sharp spines from its body.',
    NOTE_HATCHLING:
    ...
    NAME_MAGE_KNIGHT: 'Soul Warrior',
    NOTE_NIGHTMARE_GRIMM:
        '&quot;The expanse of dream in past was split,&lt;br&gt;One realm now must stay apart,&lt;br&gt;Darkest reaches, beating red,&lt;br&gt;Terror of sleep. The Nightmare&#39;s Heart.&quot;&lt;br&gt;- Seer',
    DESC_VOID_IDOL_1: 'Rare artifact from a time before Hallownest. Contains a drop of liquid from the Abyss.',
    NOTE_ZOM_SPIDER:
    ...
    DESC_FUNGOON_BABY: 'Passive fungal balloon. Internal gasses cause it to float.',
    DESC_MUSH_TURRET: 'Detects nearby movement and fires out explosive spores that drift towards their target.',
    NAME_ZOM_ROYAL_2: 'Cowardly Husk',
    NOTE_HIVE_KNIGHT:
    ...
    NOTE_CEILING_DROPPER:
        'An angry creature with no regard for its own life. A creature without fear... can it truly be called &quot;prey&quot;?',
    DESC_MAGE_KNIGHT: 'Learned bug, wielding a refined pinblade. Enhances its combat prowess with harvested soul.',
    NAME_BABY_CENTIPEDE: 'Dirtcarver',
    NAME_BIG_FAT_FLYER: 'Boofly',
    NOTE_BEE:
    ...
    DESC_JELLYFISH: 'Passive outer being protecting an aggressive, explosive core.',
    DESC_BLACK_KNIGHT: 'Discarded shell of a Watcher Knight, re-animated by a swarm of infected flies.',
    DESC_PARASITE_BLOB: 'A single-celled organism, completely infected. Scurries about simple-mindedly.',
    DESC_BIG_FAT_FLYER: 'Large, docile creature that peacefully buzzes around in the caverns of Kingdom&#39;s Edge.',
    NOTE_PLANT_SHOOTER:
    ...
    NAME_GODSEEKER_MASK: 'Weathered Mask',
    NOTE_COL_SHIELD:
    ...
    NAME_WORM: 'Goam',
    NAME_MEGA_BEAM_MINER: 'Crystal Guardian',
    NAME_PLANT_SHOOTER: 'Gulka',
    NAME_PAINTMASTER: 'Paintmaster Sheo',
    DESC_ORANGE_BALLOON: 'Single cell of infection. Has a simple mind and can float using internal gasses.',
    NOTE_ZOTE_BALLOON:
        'The Grey Prince was a wanderer by nature, but she could not bear to be separated from him. So she devised a plan to make sure that she and her prince would be together always. She only had to wait for her chance.&lt;br&gt;- &#39;The Grey Prince&#39; Chapter 205',
    NAME_CRYS_LAZER_BUG: 'Crystal Crawler',
    NOTIFICATION_HALF: 'New Journal Entry',
    NOTE_MUMMY:
    ...
    KILL_COUNT_2: 'more to decipher the Hunter&#39;s notes.',
    DESC_SENTRY_1: 'Animated remains of a Hallownest Sentry. Still retains some memory of its former task.',
    NOTE_FAT_FLUKE:
    ...
    DESC_JELLY_CRAWLER: 'Smallest Jelly form. Passive and unaware, but pulsing with a dangerous electric charge.',
    NOTE_ELEC_MAGE:
    ...
    NOTE_SNAPPER_TRAP: 'You really would have to be a fool to be tricked by a plant.',
    DESC_MOSS_WALKER: 'Weakling that covers itself in leaves to appear larger. Hides amongst the undergrowth.',
    NAME_MOSS_WALKER: 'Mosscreep',
    NAME_FUNGOON: 'Fungoon',
    NAME_FALSEKNIGHT: 'False Knight',
    DESC_GHOST_GALIEN:
        'Lingering dream of a fallen warrior. Trained in the wilds bordering the kingdom, hoping to become a Knight.',
    NAME_SENTRY_FLYING_JAVELIN: 'Lance Sentry',
    DESC_SAGE_SLY: 'Legendary sage of the nail arts and, recently, merchant of some success.',
    DESC_ZOM_SPIDER: 'Parasitic beast that controls the body of its host after the host&#39;s death.',
    DESC_MAGE: 'Highly intelligent bug that uses arcane knowledge to twist soul into vicious spells.',
    NOTE_SPIDER_FLYER:
    ...
    NAME_ZOM_SPINE: 'Spiny Husk',
    NAME_ZOM_SPIDER: 'Corpse Creeper',
    NAME_COL_ROLLER: 'Sharp Baldur',
    NOTE_PRAYER_SLUG:
    ...
    DESC_NIGHTMARE_GRIMM: 'Twisted spectre of scarlet flame.',
    DESC_CEILING_DROPPER: 'Thin wings hide a highly volatile belly. Will give its own life to protect its territory.',
    DESC_SNAPPER_TRAP: 'Carnivorous plant that snaps at any creature that comes close.',
    DESC_ZOTE_BALLOON: 'Figment of an obsessed mind. Deals poorly with the pressure of existing and quickly explodes.',
    NOTE_CLIMBER:
    ...
    DESC_ABYSS_CRAWLER: 'Found only in deep, dark places. Has never been observed to eat or drink anything.',
    NAME_BLOB_FLYER: 'Obble',
    DESC_LESSER_MAWLEK: 'Attacks by spitting acid and slashing with foreclaws. ',
    DESC_BLOBBLE:
    ...
    NAME_ZOTE_FLYER: 'Winged Zoteling',
    NOTE_ACID_FLYER:
        'Thinks itself fully protected and so is unconcerned by passers by. Attack its face, and teach it that nothing is ever safe.',
    DESC_ANGRY_BUZZER: 'Vengefly whose body has been distorted by continued infection. Highly aggressive.',
    NAME_FLAMEBEARER_MED: 'Grimmkin Master',
    DESC_FUNG_CRAWLER: 'Simple-minded crawling fungus. Its cap is covered in a layer of hardened spikes. ',
    NAME_ZOM_GUARD: 'Husk Guard',
    NAME_HATCHER: 'Aspid Mother',
    DESC_HATCHER:
        'Carries the eggs of its young inside its belly. Can hatch and birth its young as needed to deal with intruders.',
    DESC_FALSEKNIGHT: 'A maggot driven mad by a strange force. Inhabits a stolen armoured shell.',
    NOTE_SIBLING:
    ...
    NAME_GHOST_MARMU: 'Marmu',
    NAME_MUSH_BRAWLER: 'Shrumal Ogre',
    NAME_FLAMEBEARER_LARGE: 'Grimmkin Nightmare',
    NAME_GHOST_NOEYES: 'No Eyes',
    NAME_MINES_CRAWLER: 'Shardmite',
    NOTE_INFECTED_KNIGHT:
    ...
    NAME_ZOM_ROYAL_FAT: 'Gluttonous Husk',
    DESC_GORGEOUS_HUSK: 'Corpulent Husk encrusted with a shining metal. Retains the instinct to hoard Geo.',
    DESC_VOID_IDOL_2: 'Rare artifact from a time before Hallownest. Volatile liquid of the Abyss writhes within.',
    NOTE_GREAT_SHIELD_ZOMBIE:
    ...
    DESC_MOSQUITO: 'Charges at prey with its needle-like proboscis.',
    NAME_COL_FLYINGSENTRY: 'Winged Fool',
    NOTE_FLUKEMAN:
    ...
    DESC_INFECTED_KNIGHT: 'Shattered corpse, reanimated by infected parasites.',
    DESC_ACID_WALKER:
        'Simple walking creature encased in a hard shell. Often found wading in shallow pools of acidic water. ',
    DESC_ZOM_RUNNER: 'The remains of a bug, animated by a strange force. Wanders the roads where it once lived.',
    NAME_HOPPER: 'Hopper',
    DESC_SPIDER_FLYER: 'Nimble spider that traverses its domain on thin strands of web. Often waits in ambush.',
    DESC_ZOM_HIVE: 'Cowardly husk, its body colonised by hivelings. ',
    NOTE_ZOM_BURSTING:
    ...
    NOTIFICATION_FULL: 'Journal Updated',
    NAME_GRUB_MIMIC: 'Grub Mimic',
    NOTE_MOSQUITO: 'When they lunge at you, don&#39;t panic. Stand your ground, and strike back as they come close.',
    NOTE_GHOST_HU: 'Never forget what once was lost, yet do not let it tie you down.&lt;br&gt;- Elder Hu',
    NOTE_GHOST_GALIEN:
        'A Knight strives not only to protect the land and its people, but the hopes and dreams of the kingdom.&lt;br&gt;- Galien',
    NAME_COL_WORM: 'Heavy Fool',
    NAME_GREY_PRINCE: 'Grey Prince Zote',
    NOTE_GRASS_HOPPER: 'It seems like their energy is limitless! Do they ever stop to sleep, or eat, or love?',
    NOTE_MUSH_BRAWLER:
    ...
    DESC_PURE_VESSEL: 'Chosen vessel, raised and trained to prime form.',
    DESC_CRAWLER: 'Timid scavenger that crawls through the caverns looking for food.',
    NAME_HUNTERMARK: 'Hunter&#39;s Mark',
    DESC_BLOCKER: 'Bulky and covered in thick plating. Retracts into itself when attacked.',
    NOTE_GHOST_ALADAR: 'I am Gorb!&lt;br&gt;- Gorb',
    NAME_MAGE_BALLOON: 'Folly',
    NOTE_DUNG_DEFENDER:
    ...
    NAME_CLIMBER: 'Tiktik',
    DESC_COL_WORM: 'Warrior fighting for glory in the Colosseum of Fools. Aggressively charges down foes.',
    NAME_BUZZER: 'Vengefly',
    DESC_COL_MINER:
        'Warrior fighting for glory in the Colosseum of Fools. Uses crescent-shaped blades to cut down foes.',
    DESC_MOSSMAN_RUNNER: 'Plant-like bug that charges at foes when close.',
    NAME_SENTRY_1: 'Husk Sentry',
    DESC_GREAT_SHIELD_ZOMBIE:
    ...
    DESC_ZOTE_HOPPER: 'Figment of an obsessed mind. Jumps about in a nonthreatening manner.',
    NOTE_PARASITE_BLOB:
    ...
    DESC_BIG_CENTIPEDE: 'Giant burrower covered in thick shell plates. Tirelessly travels the tunnels of the Deepnest.',
    DESC_ZOM_GUARD:
    ...
    NAME_ZOM_SHIELD: 'Husk Warrior',
    DESC_GHOST_MARKOTH: 'Lingering dream of a fallen warrior. Only member of his forgotten tribe to take up a weapon.',
    NOTE_ZOM_BARGER:
    ...
    NAME_HOLLOW_KNIGHT: 'Hollow Knight',
    DESC_MOSS_KNIGHT_FAT: 'Lazy, portly Mosskin. Easily swayed by others. ',
    DESC_HOLLOW_SHADE: 'Echo of a previous life. Defeat it to retake its power and become whole.',
    NOTE_SPITTER:
    ...
    NAME_SENTRY_FLYING: 'Winged Sentry',
    NOTE_ZOTE_FLYER:
        'She asked whether he had bought the Charm for her as he promised he would, but then he explained. The Charm was actually of low quality and not worth the price asked. She understood the wisdom of his decision perfectly.&lt;br&gt;- &#39;The Grey Prince&#39; Chapter 136',
    DESC_GRUB_MIMIC: 'Assumes the shape of a harmless creature to lure prey.',
    NOTE_GHOST_XERO:
        'A life defined by tragedy and triumph. A death marred by sorrow and regret. A spirit burdened by sins and memories. Better to wander the world than be cursed with glory.&lt;br&gt;- Xero',
    DESC_FUNGOON: 'Fully grown fungal balloon. Spits built up internal gas at aggressors. ',
    NOTE_FUNGOON:
    ...
    NAME_MAWLEK_TURRET: 'Mawlurk',
    DESC_GHOST_XERO: 'Lingering dream of a fallen warrior. Executed for crimes against the King.',
    NOTE_ZOM_ROYAL_2:
    ...
    DESC_HUNTERMARK: 'The mark of a true Hunter.',
    DESC_MUSH_BABY:
        'Young fungal creature. Spends most of its time in the ground but can uproot and flee if it senses danger.',
    DESC_ZOM_BURSTING: 'Maddened by massive infection. Charges at enemies with no thought for its own preservation.',
    NAME_INFLATOR: 'Hwurmp',
    NAME_MOSSMAN_SHAKER: 'Volatile Mosskin ',
    NOTE_MAWLEK:
    ...
    NOTE_PURE_VESSEL:
        '&quot;Deepest silence in holy shell,&lt;br&gt;Given nail and named a Knight,&lt;br&gt;Bound by chain and egg and spell,&lt;br&gt;Hear Our plea! Reveal thy Light!&quot;&lt;br&gt;- Prayer to the Vessel',
    NOTE_PAINTMASTER:
        '&quot;O God inspired, master of arts,&lt;br&gt;Whose works shall eternal endure,&lt;br&gt;Peer beyond Our minds and hearts,&lt;br&gt;Reveal to Us the God most pure!&quot;&lt;br&gt;- Prayer to the Artist',
    NAME_FLUKEFLY: 'Flukefey',
    NAME_ZOM_BARGER: 'Husk Bully',
    NAME_GRASS_HOPPER: 'Loodle',
    NOTE_MANTIS_LORD:
    ...
    NAME_DUNG_DEFENDER: 'Dung Defender',
    NOTE_SPITTING_SPIDER:
        'They can be hard to spot as they flitter in and out of the darkness. Watch for their glowing eyes.',
    DESC_MUMMY: 'Mummified remains, deformed and enraged by infection.',
    DESC_ZOM_ROYAL_FAT: 'Former member of Hallownest&#39;s high society. Uses its corpulent body as a weapon.',
    NAME_ZOM_HORNHEAD: 'Husk Hornhead',
    NOTE_ACID_WALKER:
    ...
    NAME_FLUKEMAN: 'Flukemon',
    DESC_DUNG_DEFENDER:
        'Skilled combatant living at the heart of the Waterways. Assails intruders with balls of compacted dung.',
    DESC_GHOST_HU: 'Lingering dream of a fallen warrior. Travelled the world tending to those affected by the plague.',
    NAME_SPITTING_SPIDER: 'Deephunter',
    NOTE_MANTIS:

...
export const silkMapDataAllBySceneNameLower = Map.groupBy(silkMapData.rooms, (it) => it.sceneName.toLocaleLowerCase());

silkMapDataAllBySceneNameLower.forEach((rooms) => {

...
export const vesselSteelSoulImg = '/ingame-sprites/hud/select_game_HUD_0000_magic_orb_steel.png';
...
export const coin2Img = '/ingame-sprites/hud/HUD_coin_v020004.png';

...
-   **Dreamgate icon on the map**:
    The map now always displays the current location of the dreamgate is positioned. (Thank you for the idea to one of our study participants!)

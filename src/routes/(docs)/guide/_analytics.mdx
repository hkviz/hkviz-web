...
It is accessible by clicking on one of your gameplays on the <A href="/">start page</A> or by viewing a gameplay from the <A href="/run">public gameplays page</A>.
...
checkout the <A href="/guide/install">mod install guide</A>

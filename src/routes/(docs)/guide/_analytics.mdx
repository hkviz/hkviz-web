...
1.  **Select a room** by hovering over it on the map. The hovered room will be displayed in the room analytics. Showing stats for the selected routeModule.
    ...
    Hint: your selected room is not only shown in the room analytics panel, but also highlighted in the <a href="#timeline" target="_self">timeline</a>.
...
2.  {<LinkableSpan id="room-pin" initialScrollMargin={360}>
    ...
    -button in the room analytics panel or by clicking a room on the map. Rooms can also be pinned by clicking on the

...
<DataCollectionStudyParticipationForm className="mx-auto mb-5 mt-5" formPositionText="bellow" />
...
<DataCollectionStudyParticipationForm className="mx-auto mb-[20rem] mt-8" formPositionText="above" />

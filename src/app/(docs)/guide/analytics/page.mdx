...
import { PinParagraph } from './_paragraphs';
...
### Buildings and multi-room buildings
...
Inside the Hollow Knight map, the player location is not displayed when inside on of these buildings.

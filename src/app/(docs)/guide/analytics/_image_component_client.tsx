...
export function ImageArea({
    ...
    return (
        <Button
            className={cn(
                'absolute z-20 rounded-sm border-2 border-dashed border-transparent border-white bg-transparent p-0 text-transparent no-underline opacity-30 drop-shadow-glow-md transition duration-200 ease-in-out hover:bg-transparent hover:bg-opacity-0 group-hover:opacity-100',

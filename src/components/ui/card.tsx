...
const Card: Component<ComponentProps<'div'>> = (props) => {
	...
	return <div class={cn('rounded-lg border bg-card text-card-foreground shadow-xs', local.class)} {...others} />;
};
...
const CardTitle: Component<ComponentProps<'h3'>> = (props) => {
	const [local, others] = splitProps(props, ['class']);
	return <h3 class={cn('text-lg leading-none font-semibold tracking-tight', local.class)} {...others} />;
};

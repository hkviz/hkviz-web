...
import { getThemeColorByTheme } from '~/lib/viz/store/theme-store';
...
export const FaviconsHead: Component<{ theme: 'light' | 'dark' }> = (props) => {
	...
	return (
		<>
			...
			<meta name="apple-mobile-web-app-title" content="HKViz" />
			<link
			...
			/>
			<meta name="msapplication-TileColor" content="#06111d" />

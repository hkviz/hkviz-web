...
const ToastClose = <T extends ValidComponent = 'button'>(props: PolymorphicProps<T, ToastCloseButtonProps>) => {
...
const ToastTitle = <T extends ValidComponent = 'div'>(props: PolymorphicProps<T, ToastTitleProps>) => {
...
const ToastDescription = <T extends ValidComponent = 'div'>(props: PolymorphicProps<T, ToastDescriptionProps>) => {

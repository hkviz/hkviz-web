...
const Card: Component<ComponentProps<'div'>> = (props) => {
    ...
    return <div class={cn('bg-card text-card-foreground rounded-lg border shadow-sm', props.class)} {...rest} />;
};
...
const CardTitle: Component<ComponentProps<'h3'>> = (props) => {
    const [, rest] = splitProps(props, ['class']);
    return <h3 class={cn('text-lg font-semibold leading-none tracking-tight', props.class)} {...rest} />;
};

...
export function AnimationTimeLine({ className }: { className?: string }) {
    ...
    return (
        <div className={cn('@3xl:h-10 @3xl:justify-center relative flex h-5 shrink grow flex-col gap-2', className)}>
            <div>
            ...
            {!isV1 && (
                <div className="pointer-events-none absolute bottom-0 left-2.5 right-2.5 top-0">
                    {hoveredMsIntoGame != null && (
                        <div
                            className="bg-foreground absolute bottom-0 top-0 w-[1px]"

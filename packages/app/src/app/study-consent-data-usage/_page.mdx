...
# Developing Effective Map-based Analytics for Metroidvania Games - Data Collection Study
...
You can contact me via <MailLinkUnstyled /> or on Discord @olivergrack.

<Image src={jkuLogo} alt="Johannes Kepler University Logo" className="mx-auto w-[15rem] max-w-full dark:invert" />

## Goal of the research

The aim of our research is to investigate data visualization techniques used in players metrics for Hollow Knight.
